...
public class MasonListActivity extends AppCompatActivity {
        ...
        workersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snap) {
                ...
                for (DataSnapshot ds : snap.getChildren()) {
                    ...
                    if (!"Mason".equalsIgnoreCase(w.profession)) continue;
                ...
                if (list.isEmpty()) {
                    Toast.makeText(MasonListActivity.this,
                            "No masons found", Toast.LENGTH_SHORT).show();
                }
            }
