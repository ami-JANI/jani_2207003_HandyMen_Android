...
public class InternetListActivity extends AppCompatActivity {
        ...
        workersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snap) {
                ...
                for (DataSnapshot ds : snap.getChildren()) {
                    ...
                    if (!"Internet Provider".equalsIgnoreCase(w.profession)) continue;
                ...
                if (list.isEmpty()) {
                    Toast.makeText(InternetListActivity.this,
                            "No internet providers found", Toast.LENGTH_SHORT).show();
                }
            }
